...
function initializeMap() {
    ...
    var clickListener = google.maps.event.addListener(map, 'click', function (event) {
        ...
        document.getElementById('reglat').value = latitude;
        document.getElementById('reglon').value = longitude;
        ...
        if (marker) {
            ...
            marker = new google.maps.Marker({
                ...
                map: map,
                icon: '/assets/img/icones/aluno-marcador.png' // Adicione o caminho para o seu ícone personalizado aqui
            });
        }
                ...
                if (results[0]) {
                    ...
                    address_components.forEach(function (component) {
                        ...
                        if (types.includes('route')) {
                            document.getElementById('inputAddress').value = component.long_name;
                        }
                        if (types.includes('street_number')) {
                            document.getElementById('inputNumber').value = component.long_name;
                        }
                        if (types.includes('postal_code')) {
                            document.getElementById('inputZip').value = component.long_name;
                        }
                    });
                } else {
